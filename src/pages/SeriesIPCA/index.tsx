...
export function SeriesIPCAPage() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((response) => {
        ...
        // Iniciar tour após os dados carregarem
  ...
  return (
    <div>
        ...
        <>
          <div data-tour="title-section">
            <BlueTitleCard
              ...
              subtitle="Consulte a tabela abaixo para visualizar a série histórica do IPCA desde dezembro de 1979. Os dados são atualizados regularmente com base nas informações oficiais do IPEA."
            />
          </div>
      ...
      {/* Tour Guide - só exibe se os dados carregaram */}
      {!loading && !error && (
        <>
          <TourGuide
