...
export function LoadingIndicator({
  ...
  const totalAnosEsperados =
    anoInicial && anoFinal ? anoFinal - anoInicial + 1 : 0;
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/50">
      ...
      >
        <div className="flex flex-col items-center w-full">
          ...
          <div className="w-full mb-6" data-tour="progress-bar">
            <div className="flex justify-between text-sm text-gray-600 mb-2">
              <span>{progresso}% Concluído</span>
              <span>
                {registrosProcessados > 0
                  ? `${registrosProcessados.toLocaleString(
                      "pt-BR"
                ...
                <div className="text-lg font-semibold">
                  ...
                  {totalRegistros > 0 &&
                    totalRegistros > registrosProcessados && (
                      <span className="text-gray-500">
                        {" "}
                        de ~{totalRegistros.toLocaleString("pt-BR")}
                      </span>
                    )}
                </div>
              </div>
            ...
            {anoInicial && anoFinal && (
              <div className="mt-3 pt-3 border-t border-blue-200">
                ...
                <div className="grid grid-cols-5 gap-2">
                  {Array.from({ length: anoFinal - anoInicial + 1 }).map(
                    (_, i) => {
